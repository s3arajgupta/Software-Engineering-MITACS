var fs = require('fs');
var AR = require('./Element_day1.json');
...
for (var i = 0; i < AR.length; i++) {
    ...
    if (stargazerCount >= 3) {
        ...
        output.push({createdAt, nameWithOwner, stargazerCount, description, repositoryTopics_list, primaryLanguage, languages_list, diskUsage});
    }
